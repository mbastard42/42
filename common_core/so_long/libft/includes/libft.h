...
/*   Updated: 2022/04/05 19:35:43 by mbastard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief 	writes the string (str) to the output (fd)
 *
 * @param fd 	file descriptor
 ...
 * @return 				trimed str
 */
char	*ft_strtrim(char *s1, char const *set, int clean_str);
